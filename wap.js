...
this.wordle.bundle = function(e) {
	...
	async function fetchDef(word) {
	  ...
	  if (!response.ok) {
	    console.log("An error occured fetching definition: " + word);
		return null;
	  }
    ...
    Sa.innerHTML = '\n  <style>\n  .setting {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    border-bottom: 1px solid var(--color-tone-4);\n    padding: 16px 0;\n  }\n\n  a, a:visited {\n    color: var(--color-tone-1);\n  }\n\n  .title {\n    font-size: 18px;\n  }\n  .text {\n    padding-right: 8px;\n  }\n  .description {\n    font-size: 12px;\n    color: var(--color-tone-2);\n  }\n\n  #footnote {\n    position: absolute;\n    bottom: 0;\n    right: 0;\n    padding: 16px;\n    color: var(--color-tone-2);\n    font-size: 12px;\n    text-align: right;\n  }\n\n  @media only screen and (min-device-width : 320px) and (max-device-width : 480px) {\n    .setting {\n      padding: 16px;\n    }\n  }\n\n  </style>\n  <div class="sections">\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Hard Mode</div>\n          <div class="description">Any revealed hints must be used in subsequent guesses</div>\n        </div>\n        <div class="control">\n          <game-switch id="hard-mode" name="hard-mode"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Dark Theme</div>\n        </div>\n        <div class="control">\n          <game-switch id="dark-theme" name="dark-theme"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Color Blind Mode</div>\n          <div class="description">High contrast colors</div>\n        </div>\n        <div class="control">\n          <game-switch id="color-blind-theme" name="color-blind-theme"></game-switch>\n        </div>\n      </div>\n    </section>\n\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title"><a href="https://www.powerlanguage.co.uk/wordle" target="_blank">WORDLE</a> is created by Josh Wardle</div>\n  <div class="description">All credit due to Josh for this fun and elegant game.</div>      </div>\n        <div class="control">\n          <a href="https://twitter.com/powerlanguish" target="blank" title="@powerlanguish">Twitter</a>\n        </div>\n      </div>\n    </section>\n\n<section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Modified by Greg Cameron</div>\n  <div class="description">Updated May 3 2022 with a new & improved word list. Enjoy!</div>      </div>\n        <div class="control" style="text-align:right;">\n          <a href="https://twitter.com/donaldtrump" target="_blank" title="@shar">Twitter</a><br/>\n <a href="https://www.paypal.com/donate/?business=AWM8ZAYTVQZGG&amount=2.7&no_recurring=1&item_name=Buy+me+a+coffee%21&currency_code=USD" target="_blank" title="TICKETS TO CORNMAZE">TICKETS TO CORNMAZE</a>\n       </div>\n      </div>\n    </section>\n </div>\n  <div id="footnote">\n    lucky number <div id="puzzle-number"></div>\n    <div id="hash"></div>\n  <div>\n';
    var _a = function(e) {
        n(t, e);
        var a = h(t);
        function t() {
        ...
        return o(t, [{
            ...
            value: function() {
                ...
                this.$game.addEventListener("game-last-tile-revealed-in-row", (function(a) {
                    ...
                    (a.path || a.composedPath && a.composedPath()).includes(s) && ([Za, es].includes(e.gameStatus) && (e.restoringFromLocalStorage ? e.showStatsModal() : (e.gameStatus === Za && (s.setAttribute("win", ""), e.addToast(as[e.rowIndex - 1], 2e3)),
                    e.gameStatus === es && fetchDef(e.solution).then(function(data) {
						var def = "";
						if (data !== null) {
							def = data[0]["meanings"][0]["definitions"][0]["definition"];
							def = ": " + def.charAt(0).toUpperCase() + def.slice(1);
						}
						e.addToast(e.solution.toUpperCase() + def, 1 / 0) }),
                    setTimeout((function() {
                        e.showStatsModal()
                    }
                    ), 2500))),
    ...
    var ls = [["q", "w", "e", "r", "t", "y", "u", "i", "o", "p"], ["-", "a", "s", "d", "f", "g", "h", "j", "k", "l", "-"], ["â†µ", "z", "x", "c", "v", "b", "n", "m", "â†"]]
      , ds = function(e) {
        n(t, e);
        var a = h(t);
        function t() {
        ...
        return o(t, [{
            ...
            value: function() {
                ...
                this.shadowRoot.querySelector("button#share-button").addEventListener("click", (function(a) {
                    a.preventDefault(),
                    a.stopPropagation();
					e.parentNode.shadowRoot.getElementById("close-icon").click()
					if ("IN_PROGRESS" !== e.gameApp.gameStatus) {
						location.reload();
                	} else {
                		e.gameApp.addToast("You must finish what you've started", 1200);
                	}
